...
<div class="products-row business">
    ...
    <div class="product-cell image">
        <img src="img/ProdImg/New Project 1 [7A467A2].png" alt="product">
...
<div class="products-row digital-marketing">
    ...
    <div class="product-cell image">
        <img src="img/ProdImg/images (46).jpeg" alt="product">
...
<div class="products-row digital-marketing">
    ...
    <div class="product-cell image">
        <img src="img/ProdImg/New Project 4 [4CDD1E7].png" alt="product">
...
<div class="products-row graphics-design">
    ...
    <div class="product-cell image">
        <img src="img/ProdImg/New Project 17 [B70888D].png" alt="product">
...
<div class="products-row music-and-audio">
    ...
    <div class="product-cell image">
        <img src="img/ProdImg/New Project 1 [01EC0B8].png" alt="product">
...
<div class="products-row lifestyle">
    <a href="details.php?image=p8.png&product_name=Work%20Out%20Plans&category=Lifestyle&creator=Baby%20Lyka%20Cinco&price=200" class="cell-more-button">
        <span class="button-text">View Details</span>
    </a>
    <div class="product-cell image">
        <img src="img/ProdImg/p8.png" alt="product">
...
<div class="products-row business">
    ...
    <div class="product-cell image">
        <img src="img/ProdImg/images (44).jpeg" alt="product">
...
<div class="products-row graphics-design">
    ...
    <div class="product-cell image">
        <img src="img/ProdImg/Video and Photo Editing.jpg" alt="product">
...
<div class="products-row music-and-audio">
    ...
    <div class="product-cell image">
        <img src="img/ProdImg/New Project [B347ED2].png" alt="product">
...
<div class="products-row lifestyle">
    ...
    <div class="product-cell image">
        <img src="img/ProdImg/New Project 4 [582B4B7].png" alt="product">
